...
internal class ActivateAdapter2 : RecyclerView.Adapter<ActivateAdapter2.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_item_activate2, parent, false)
